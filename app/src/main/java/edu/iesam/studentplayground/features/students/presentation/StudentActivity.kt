...
import edu.iesam.studentplayground.features.students.presentation.StudentViewModel
...
class StudentActivity : AppCompatActivity() {
    ...
    fun initStudents() {
        ...
        val getAllUseCase = GetAllStudentsUseCase(dataRepository)
        ...
        Log.d("@dev", "Stop")
        viewModel.viewStudents()
        viewModel.update("0001", "Nicolas Savuica")
        viewModel.viewStudents()
        viewModel.delete("0001")
